package com.example.abiralrai.fitdiaryproject.FatSecretImplementation;
...
public class FatSecretSearch {
    ...
    final static private String APP_KEY = "a817a74259bd48b0973f1a171989ef7b";
    final static private String APP_SECRET = "fdd2d2c7795941df82578f6fe0cec597&";
    ...
    public JSONObject searchFood(String searchFood, int page) {
        ...
        try {
            ...
            Log.e("FatSecret Error"+searchFood, exception.toString());
